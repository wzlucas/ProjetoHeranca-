        ...
        foreach ($documentos as $doc) {
            if ($doc instanceof Processo && $doc->getNumeroProcesso() == $numeroProcesso) {
                if ($doc->getEmpenho() !== null) {
                    ...
                    $protocolo->setEmpenho($doc->getEmpenho());
                    $protocolo->setNumeroLiquidacao(readline("Informe o número de liquidação: ")); 
                    $protocolo->setNome($doc->getNome());
                    $protocolo->setCpfCnpj($doc->getCpfCnpj());
